...
/**************************   atmega328P (Promini)  ************************************/
 ...
 // davin #define SERVO_2_PINMODE            pinMode(A1,OUTPUT); // TILT_ROLL  - WING right
...
//********************************************************************************************************************************************************************************************************************************************************************************************************************
...
#if defined(MX_MICRO_MultiWii_V2)      
...
#if defined(MX_MICRO_MultiWii_BEC_V2)      
...
#if defined(MX_MINI_MultiWii_V1_2)
 ...
 // #define SERIAL_SUM_PPM         THROTTLE,ROLL,YAW,PITCH,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For Graupner/Spektrum
  ...
  #define ACC_ORIENTATION(X, Y, Z) {imu.accADC[ROLL]  =  Y; imu.accADC[PITCH]  = -X; imu.accADC[YAW]  =  Z;} 
  #define GYRO_ORIENTATION(X, Y, Z){imu.gyroADC[ROLL] =  X; imu.gyroADC[PITCH] =  Y; imu.gyroADC[YAW] =  Z;} //mwm: I've turned around the Z axis!
  #define MAG_ORIENTATION(X, Y, Z) {imu.magADC[ROLL]  = -Y; imu.magADC[PITCH]  = -X; imu.magADC[YAW]  =  Z;}

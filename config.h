...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
     ...
     // #define MX_MINI_MultiWii_V1_2   // MPU6050 + BMP085 + HMC5883 + DMS2_RX(8CH PPM)
     // #define MX_MINI_AIO_PRO_V1    // MPU6050 + BMP085 + HMC5883 + DMS2_RX(8CH PPM)
      #define MX_NANO_MultiWii_V1_31   // MPU6050 + BMP085 + HMC5883 + DMS2_RX(8CH PPM)
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_OFF_DELAY 0                    // 200 Time for Landing before motors stop in 0.1sec. 1 step = 0.1sec - 20sec in example
    #define FAILSAFE_THROTTLE  (MINTHROTTLE )    // (*) Throttle level used for landing - may be relative to MINTHROTTLE - as in this case  (MINTHROTTLE + 200) 
